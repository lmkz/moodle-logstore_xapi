...
$string['taskclientemit'] = 'Skicka klientsidiga uttryck till LRS';
$string['privacy:path:client'] = 'Klientsidiga uttryck';
$string['privacy:metadata:logstore_xapi_client_log'] = 'Klientsidiga xAPI-uttryck i kö för bearbetning';
$string['privacy:metadata:logstore_xapi_client_log:statement'] = 'Det klientsidiga xAPI-uttrycket som togs emot från webbläsaren.';
$string['privacy:metadata:logstore_xapi_client_log:statementid'] = 'xAPI-uttryckets id, när det finns.';
$string['privacy:metadata:logstore_xapi_client_log:userid'] = 'Moodle-användaren som var autentiserad när uttrycket togs emot.';
$string['privacy:metadata:logstore_xapi_client_log:contextid'] = 'Moodle-kontexten som var kopplad till mottagandet av uttrycket.';
$string['privacy:metadata:logstore_xapi_client_log:courseid'] = 'Moodle-kursen som var kopplad till uttrycket, när tillgänglig.';
$string['privacy:metadata:logstore_xapi_client_log:ip'] = 'IP-adressen som uttrycket togs emot från.';
$string['privacy:metadata:logstore_xapi_client_sent'] = 'Klientsidiga xAPI-uttryck som har skickats till LRS.';
$string['privacy:metadata:logstore_xapi_client_sent:statementid'] = 'xAPI-uttryckets id, när det finns.';
